  ...
  setup() {
    Object.keys(args).forEach((key) => {
      if (typeof args[key] === 'object') {
        args[key] = JSON.stringify(args[key], null, 4)
      }
    })
...
offCanvas.args = {
  ...
  signature: 'Identificação do site ou sistema',
  list: `[
      {
        'id': 1,
        'icon': 'bell',
  ...
  social: `[
    {
      'url': 'javascript:void(0)',
      'ariaLabel': 'Compartilhar por Twitter',
      'icon': 'twitter',
      'iconFamily': 'fab'
    },
    {
    ...
    {
      'url': 'javascript:void(0)',
      'ariaLabel': 'Compartilhar por Whatsapp',
      'icon': 'whatsapp',
      'iconFamily': 'fab'
    }
  ]`,
  socialTitle: 'Redes Sociais',
  info: 'Todo o conteúdo deste site está publicado sob a licença Creative Commons Atribuição-SemDerivações 3.0',
}
offCanvas.parameters = {
  controls: { exclude: ['isContextual', 'contextualLabel', 'isPush'] },
}

export const contextual = Template.bind({})
contextual.args = {
  isContextual: true,
  contextualLabel: 'Rótulo do Menu Contextual',
  list: `
  [
    {
      'id': 1,
...
contextual.parameters = {
  controls: { exclude: ['isPush'] },
}

const TemplatePush = (args) => ({
  props: Object.keys(args),
  setup() {
    return { args: kebabiseArgs(args) }
  },
      ...
      <div class="col">
        <div class="d-flex align-items-center">
          <br-button
            ...
            data-target="#push"
          ></br-button>
          <div class="ml-3">Clique para abrir o Menu Push</div>
        </div>
      </div>
    </div>
    `,
...
export const push = TemplatePush.bind({})
push.args = {
  isPush: true,
  showMenu: false,
  id: 'push',
...
push.parameters = {
  controls: { exclude: ['isContextual', 'contextualLabel'] },
}

const TemplateDensities = (args) => ({
  props: Object.keys(args),
  setup() {
    return { args: kebabiseArgs(args) }
  },
...
export const densidadeAlta = TemplateDensities.bind({})
densidadeAlta.args = {
  isPush: true,
  density: 'small',
  list: `[
...
export const densidadeBaixa = TemplateDensities.bind({})
densidadeBaixa.args = {
  isPush: true,
  density: 'large',
  list: `[
